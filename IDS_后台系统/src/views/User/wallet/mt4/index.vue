  ...
  <transition name="fade">
    <div class="inner_wrap" style="overflow: hidden;">
      <el-scrollbar style="height: 100%;">
        <!-- 现金钱包 -->
        <div class="item_title">{{ $t('user.mt4_wallet') }}</div>
        <div class="item_box">
          <div class="item_table_box">
            ...
            >
              ...
              <!-- 用户名 -->
              <el-table-column width="120" prop="associatedAccount" :label="$t('wallet_details.username')">
                <template slot-scope="scope">{{ scope.row.username||'--' }}</template>
              </el-table-column>
              <!-- MT4 ID -->
              <el-table-column width="100" prop="money" :label="$t('wallet_details.mt4_id')">
                <template slot-scope="scope">{{ scope.row.mt4_id }}</template>
              </el-table-column>
              <!-- 备注 -->
